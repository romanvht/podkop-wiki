...
Это может быть полезно для локальных сервисов, не поддерживающих настройку DNS сервера. В таких случаях использование `fakeip` может приводить к циклическому резолву и замыканию трафика обратно в sing-box.